...
def build_model(nn_hdim, num_passes=20000, print_loss=False):# Initialize the parameters to random values. We need to learn these.
    np.random.seed(0)
    ...
    for i in range(0, num_passes):
        ...
        delta2 = delta3.dot(W2.T) * np.where(a1<=0,0,1)
