...
def build_model(nn_hdim, epsilon, num_passes=20000, print_loss=False):# Initialize the parameters to random values. We need to learn these.
    np.random.seed(0)
...
model = build_model(3, epsilon, 20000, True)
a = max_min(X)
